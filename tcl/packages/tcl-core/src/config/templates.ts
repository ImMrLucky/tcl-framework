...
export interface NarrativeTemplates {
  ...
  recommendedActions: {
    contradiction: Array<{ type: string; action: string }>;
    ungrounded: Array<{ type: string; action: string }>;
    unverified: Array<{ type: string; action: string }>;
    circular: Array<{ type: string; action: string }>;
    policyViolation: Array<{ type: string; action: string }>;
    generic: Array<{ type: string; action: string }>;
  };
...
export const DEFAULT_TEMPLATES: NarrativeTemplates = {
  titles: {
 ...
 */
export function getTemplates(custom?: Partial<NarrativeTemplates>): NarrativeTemplates {
  if (!custom) {
