...
export class PipelineTimer {
  ...
  count(key: string, value: number = 1): void {
...
let currentTimer: PipelineTimer | null = null;

export function startPipelineTimer(): PipelineTimer {
  currentTimer = new PipelineTimer();
  return currentTimer;
}

export function getPipelineTimer(): PipelineTimer | null {
  return currentTimer;
}
