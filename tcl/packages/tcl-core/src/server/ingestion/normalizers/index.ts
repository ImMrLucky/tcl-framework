...
import { Normalizer, NormalizerOptions, NormalizerResult, NormalizedConversation, NORMALIZED_SCHEMA_VERSION, generateChecksum } from "../types.js";
 ...
 */
function createAudioMetadataConversation(
  content: Buffer | string,
  filename: string,
  format: string
 ...
 */
function createUnknownConversation(content: Buffer | string, filename: string): NormalizedConversation {
  return {
    schemaVersion: NORMALIZED_SCHEMA_VERSION,
    channel: "other",
