 ...
 */
export const SPEAKER_ROLE_PATTERNS: Record<ParticipantRole, RegExp[]> = {
  agent: [
 ...
 */
export function mapSpeakerToRole(rawSpeaker: string): { role: ParticipantRole; mappingDecision: string } {
