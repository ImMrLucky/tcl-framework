 ...
 */
function validateScoringConfig(
  ...
  try {
    validateRiskRankingConfig(riskRankingConfig as RiskRankingConfig);
  } catch (error: any) {
 ...
 */
export function computeConfigHash(riskRankingConfig: any, issueScoringConfig: any): string {
 ...
 */
export async function getActiveScoringProfile(orgId: string): Promise<{ riskRankingConfig: any; issueScoringConfig: any; configHash: string } | null> {
  if (!supabaseAdmin) {
    return null;
  }
...
export function setupScoringProfilesRoutes(app: express.Application) {
  // ============================================================================
