...
import type { TclIssueV3, SeverityCounts, ConfidenceBandCounts, VerificationCounts } from '../contracts/issue.contract.js';
 ...
 */
export function computeIssueSummaryV3(issues: TclIssueV3[]): IssueSummaryV3 {
  ...
  // Initialize counters
  const severityCountsImpact: SeverityCounts = {
    critical: 0,
    high: 0,
    medium: 0,
    low: 0,
  ...
  const verificationCounts: VerificationCounts = {
    TRANSCRIPT_ONLY: 0,
    DOC_BACKED: 0,
    EXTERNALLY_VERIFIED: 0,
  };
