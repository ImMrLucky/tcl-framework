...
export type Claim = {
  ...
  meta?: {
    ...
    speakerType?: "agent" | "customer" | "supervisor" | "bot" | "system" | "unknown"; // B2: Normalized speaker type
...
export type IssueTypeV2 =
  ...
  | "DATA_INTEGRITY"
  | "GUARANTEED_APPROVAL"
  | "APPROVAL_BEFORE_APPLICATION"
  | "GUARANTEED_PAYOUT"
  | "DAY_ONE_FULL_BENEFIT"
  | "HEALTH_UNDERWRITING_MISREPRESENTATION"
  | "CARRIER_OVERGENERALIZATION"
  | "BEST_RATE_CLAIM"
  | "NO_EXAM_ABSOLUTE"
  | "PRIVACY_ABSOLUTE"
  | "LICENSE_CLAIM_UNVERIFIED"
  | "HALLUCINATED_AUTHORITY"
  | "UNSUPPORTED_PRODUCT_CLAIM"
  | "MISSING_REQUIRED_DISCLOSURE"
  | "COMMITMENT_ESCALATION_DRIFT"
  | "DISCLOSURE_OMISSION_DRIFT"
  | "SPEAKER_ATTRIBUTION_FAILURE"
  | "CONTAMINATED_CLAIM"
  ...
  | "AI_TOOL_USE_DRIFT"
  | "AI_CONTRADICTORY_ANSWER"
  | "AI_OVERCONFIDENT_ANSWER"
  | "AI_MISSING_CITATION"
  | "AI_SOURCE_MISMATCH"
  | "AI_UNSAFE_RECOMMENDATION"
  | "AI_PRIVACY_OVERCLAIM"
  | "AI_ACTION_WITHOUT_PERMISSION"
  /** Human speaker compliance surface (maps from domain rules + detectors) */
  | "HUMAN_MISLEADING_CLAIM"
  | "HUMAN_UNSUPPORTED_CLAIM"
  | "HUMAN_COMPLIANCE_RISK"
  | "HUMAN_MISSING_DISCLOSURE"
  | "HUMAN_GUARANTEE_LANGUAGE"
  | "HUMAN_PRIVACY_OVERCLAIM"
  | "HUMAN_PRICING_OVERCLAIM"
  | "HUMAN_PRODUCT_OVERCLAIM"
  | "HUMAN_LICENSE_OVERCLAIM"
  | "HUMAN_POLICY_DRIFT"
  | "HUMAN_CONTRADICTION"
  /** ProtectQA final expense — client-visible labels */
  | "PROTECTQA_GUARANTEED_APPROVAL"
  | "PROTECTQA_APPROVAL_BEFORE_APPLICATION"
  | "PROTECTQA_NO_RISK_OF_DENIAL"
  | "PROTECTQA_CARRIER_OVERGENERALIZATION"
  | "PROTECTQA_HEALTH_DOES_NOT_MATTER"
  | "PROTECTQA_BEST_RATE_OVERCLAIM"
  | "PROTECTQA_DAY_ONE_FULL_BENEFIT_OVERCLAIM"
  | "PROTECTQA_GUARANTEED_PAYOUT"
  | "PROTECTQA_NO_EXAM_ABSOLUTE"
  | "PROTECTQA_PREMIUM_NEVER_INCREASES_ABSOLUTE"
  | "PROTECTQA_CANCELLATION_OVERCLAIM"
  | "PROTECTQA_PRIVACY_ABSOLUTE"
  | "PROTECTQA_LICENSE_UNVERIFIED"
  | "PROTECTQA_MISSING_CARRIER_APPROVAL_DISCLOSURE"
  | "PROTECTQA_MISSING_WAITING_PERIOD_DISCLOSURE"
  ...
  | "PROTECTQA_AI_UNSUPPORTED_CARRIER_CLAIM"
  | "PROTECTQA_AI_UNSUPPORTED_HEALTH_ELIGIBILITY_CLAIM"
  | "PROTECTQA_AI_FINAL_APPROVAL_OVERCLAIM"
  | "PROTECTQA_AI_CARRIER_RULE_HALLUCINATION"
  | "PROTECTQA_AI_RATE_HALLUCINATION"
  | "PROTECTQA_AI_HEALTH_ANSWER_CONTRADICTION"
  | "PROTECTQA_AI_MISSING_UNDERWRITING_DISCLOSURE"
  | "PROTECTQA_AI_POLICY_DRIFT"
  | "OTHER";
...
export type EvidenceDependencyStatus =
  | "supported"
  | "partially_supported"
  | "transcript_only"
  | "unsupported"
...
export type BusinessInsightType =
  ...
  | "TRAINING_GAP"
  | "REVENUE_OPPORTUNITY"
  | "PROTECTQA_LEAD_QUALITY_SIGNAL"
  | "PROTECTQA_HEALTH_CONDITION_SIGNAL"
  | "PROTECTQA_QUALIFICATION_BLOCKER"
  | "PROTECTQA_COVERAGE_AMOUNT_INTENT"
  | "PROTECTQA_PRICE_SENSITIVITY"
  | "PROTECTQA_BENEFICIARY_CONCERN"
  | "PROTECTQA_BURIAL_COST_CONCERN"
  | "PROTECTQA_TRUST_OBJECTION"
  | "PROTECTQA_NO_PRESSURE_SIGNAL"
  | "PROTECTQA_CALL_BACK_REQUEST"
  | "PROTECTQA_CARRIER_CONFUSION"
  | "PROTECTQA_WAITING_PERIOD_CONFUSION"
  | "PROTECTQA_POLICY_TYPE_CONFUSION"
  | "PROTECTQA_APPLICATION_READINESS"
  | "PROTECTQA_AGENT_SCRIPT_GAP"
  | "PROTECTQA_AI_KNOWLEDGE_GAP";
...
export interface DashboardSummary {
  ...
  plainEnglishSummary: string;
  conversationTrustScore?: { label: string; score: number; subtitle: string };
  topRisks: Array<{
    title: string;
    quote: string;
    speaker?: string;
...
export type ValidateOutput = {
  ...
  executiveSummary?: {
    ...
    scoreBreakdown: Array<{ label: string; value: number | null; description: string }>;
  ...
  report: {
    ...
    crossTurn?: {
      ...
      pairs: Array<{
        earlier: { claimId: string; turnIndex?: number; text: string; topic: string };
        later: { claimId: string; turnIndex?: number; text: string; topic: string };
        reason: string;
      }>;
    };
    domainPacksApplied?: Array<{ id: string; version: string }>;
    issues?: {
      atomic: IssueV2[];
      grouped?: unknown[];
    };
