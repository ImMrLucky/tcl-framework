...
export const TELCO_TEMPLATE_CONFIG: TemplateConfig = {
...
export const LOANS_TEMPLATE_CONFIG: TemplateConfig = {
  ...DEFAULT_TEMPLATE_CONFIG,
  templateId: 'loans',
...
export const AI_CHAT_TEMPLATE_CONFIG: TemplateConfig = {
  ...DEFAULT_TEMPLATE_CONFIG,
  templateId: 'ai_chat',
...
export function mergeTemplateConfig(overrides: Partial<TemplateConfig>): TemplateConfig {
