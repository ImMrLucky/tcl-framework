...
export function buildRunDiagnostics(input: DiagnosticsInput): RunDiagnostics {
...
export function validateGraphIntegrity(graph: ClaimGraph): GraphIntegrityResult {
...
export interface FormattedDiagnostics {
  ...
  counters: Record<string, { label: string; value: number }>;
}

export function formatDiagnosticsForUI(diagnostics: RunDiagnostics): FormattedDiagnostics {
