 ...
 */
export declare function validateCanonicalTranscript(transcript: any): transcript is CanonicalTranscript;
/**
 * Normalize a transcript to canonical format
 */
export declare function normalizeToCanonical(raw: any, source: TranscriptSource, metadata?: Record<string, any>): CanonicalTranscript;
