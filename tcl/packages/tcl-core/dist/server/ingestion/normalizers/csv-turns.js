 ...
 */
import { NORMALIZED_SCHEMA_VERSION, mapSpeakerToRole, generateChecksum, detectCSVColumnMapping, } from "../types.js";
/**
...
export class CSVTurnsNormalizer {
    name = "csv-turns";
    extensions = [".csv"];
    ...
    async normalize(content, options) {
        ...
        for (let i = 1; i < lines.length; i++) {
            ...
            const participantId = this.getOrCreateParticipant(participantsMap, rawSpeaker || "Unknown", role);
