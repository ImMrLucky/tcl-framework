...
export class EntitlementsService {
     ...
     */
    async getEntitlementsForTier(tier) {
     ...
     */
    getDefaultEntitlementsForTier(tier) {
     ...
     */
    async require(orgId, featureKey) {
     ...
     */
    cacheEntitlements(orgId, entitlements) {
        cache.set(orgId, {
            entitlements,
