 ...
 */
import { extractEntities, sharesPrimaryEntity } from './entity-extractor.js';
 ...
 */
export function areSameSubject(textA, textB) {
 ...
 */
function extractSubjectFromEntities(text) {
 ...
 */
export function hasOpposingPolarity(textA, textB) {
    // Negation indicators
 ...
 */
export function checkContradiction(textA, textB) {
    const reasons = [];
    let score = 0;
