 ...
 */
export function findSharedEntities(textA, textB) {
 ...
 */
export function entitySimilarity(textA, textB) {
    const entitiesA = extractEntities(textA);
    const entitiesB = extractEntities(textB);
...
export function detectAmountConflicts(textA, textB) {
    const conflicts = [];
    const entitiesA = extractEntities(textA);
    const entitiesB = extractEntities(textB);
...
export function detectPolarityConflicts(textA, textB) {
    const conflicts = [];
