...
export function detectHallucinations(claims, context) {
    const classifications = [];
    const issueSeedClaims = [];
    let penalty = 0;
...
function makeHallucinationIssue(claim, isAuthority, context) {
    ...
    return {
        ...
        what: {
            ...
            whyItMatters: "Unsupported statements increase hallucination risk, mis-set customer expectations, and weaken audit defensibility.",
