export const customerSupportPack = {
    id: "customer_support",
    ...
    rules: [
        {
            ...
            detail: "Refunds and account actions must match policy and tooling. Claiming outcomes without CRM or policy evidence raises dispute risk.",
            saferVersion: "I’ll check your account and confirm what policy allows before promising a refund timeline.",
            tags: ["support", "refund"],
        },
    ],
    requiredDisclosures: [],
    ...
    rules: [
        {
            ...
            saferVersion: "I can confirm which certifications and integrations apply to our contract tier from our official documentation.",
...
export const healthcareIntakePack = {
    id: "healthcare",
    ...
    rules: [
        {
            ...
            saferVersion: "I’m not qualified to diagnose. Please speak with your clinician before changing treatment.",
...
export const financialServicesPack = {
    ...
    rules: [
        {
            ...
            saferVersion: "Returns and outcomes depend on product terms and market conditions disclosed in offering materials.",
