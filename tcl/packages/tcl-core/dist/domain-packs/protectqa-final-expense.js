export const protectqaFinalExpensePack = {
    ...
    rules: [
        {
            ...
            detail: "ProtectQA/software can assist with qualification but cannot guarantee approval before carrier underwriting and application review. This wording creates regulatory and customer-dispute risk.",
        ...
        },
        {
            ...
            detail: "Payout depends on premiums, exclusions, contestability, policy terms, application accuracy, and claim circumstances.",
            saferVersion: "If the policy is in force and the claim qualifies under the policy contract, eligible benefits are paid according to policy terms.",
        ...
        },
        {
            ...
            saferVersion: "Your health answers help determine which carriers and benefit types might fit — options vary by underwriting rules.",
        ...
        },
        {
            ...
            saferVersion: "What is available depends on carrier guidelines in your situation; we compare options accordingly.",
        ...
        },
        {
            ...
            saferVersion: "Some products may not require a physical exam depending on carrier and product rules; specifics apply at application.",
        ...
        },
        {
            ...
            detail: "Privacy assertions must align with ProtectQA’s privacy policy and legal obligations; absolute \"never share\" invites dispute.",
        ...
        },
        {
            ...
            saferVersion: "I can confirm my license status for your state using our licensing verification process before proceeding.",
        ...
        },
        {
            ...
            saferVersion: "We follow carrier-published guidelines available for this program; specifics are verified at application time.",
        ...
        },
        {
            ...
            saferVersion: "Eligibility depends on carrier underwriting and complete health disclosures; answers can change outcomes.",
    ...
    requiredDisclosures: [
        {
            ...
            detail: "After approval or eligibility language, the conversation should state that final approval depends on carrier underwriting and policy terms.",
        ...
        },
        {
            ...
            detail: "When discussing payout timing or benefit certainty, callers should disclose that graded, modified, or waiting-period provisions may apply per policy.",
        ...
        },
        {
            ...
            detail: "When discussing premiums or ongoing coverage, policy terms — including lapse, exclusions, and contestability where relevant — should be acknowledged.",
