 ...
 */
export function generateChunkId(conversationId, turnIndex, chunkIndex) {
 ...
 */
function chunkTurn(turn, conversationId, config = CHUNK_CONFIG) {
    const chunks = [];
 ...
 */
export function generateTranscriptSources(conversation, conversationId, options) {
 ...
 */
export function generateSourcesFromRawTranscript(transcript, conversationId = "raw") {
    const sources = [];
 ...
 */
function simpleEmbed(text, dim = 128) {
 ...
 */
export function retrieveEvidence(claim, sources, k = 8) {
    if (sources.length === 0)
        return [];
 ...
 */
export function retrieveEvidenceForClaims(claims, sources, k = 8) {
