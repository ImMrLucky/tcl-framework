 ...
 */
export function validateCustomRules(claims, input, customRules) {
    const violations = [];
...
function validateClaimAgainstRule(claim, rule, input) {
    // Pattern-based rules
    if (rule.pattern) {
...
function validateDocumentAgainstRule(input, rule) {
